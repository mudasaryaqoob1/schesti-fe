...
const initialState: NetworkState = { invited: false, myNetwork: false, schestiNetwork: false, selectedTrades: [], selectedStates: [] }
...
export const { SetInvitedClient, SetMyNetwork, SetSchestiNetwork, setSelectedTrades, setSelectedStates } = networkSlice.actions
