                ...
                <div className=" w-full max-w-[523px]">
                  <div className="pb-5">
                    <h1 className="font-Gilroy font-bold text-[24px] md:text-[48px] tracking-[-1.2px] text-gray_dark md:leading-[56px]">
                      ...
                      <span className="text-blue">Takeoffs</span>
                    </h1>
                  </div>
          ...
          <div className="w-full max-w-[580px]">
            <div className="">
              <h1 className="font-Gilroy font-bold text-[30px] md:text-[40px]  text-dark_black md:leading-[60px]">
                <span className="text-blue">Bid Faster</span> And More
                Efficiently Bid Farewell To Manual Methods.
              </h1>
            </div>
            <div className=" pt-[24px] w-full max-w-[522px]">
              <p className="font-normal font-Gilroy text-[15px] md:text-[18px] text-Slate_Blue leading-[36px]">
        ...
        <div className="container">
          <div className="flex flex-col lg:flex-row justify-between items-center gap-12 lg:gap-12 md:py-[78px] px-4 lg:px-0">
            <div className="w-full max-w-[465px]">
              <div className="">
                <h1 className="font-Gilroy font-bold text-[30px] md:text-[40px] tracking-[-1.2px] text-dark_black md:leading-[60px]">
                  Optimized material costs and budget control
                </h1>
              </div>
              <div className=" py-[24px]">
                <p className="font-normal font-Gilroy text-[15px] md:text-[19px] text-dark_black tracking-[-0.2px] leading-[36px]">
            ...
            <div className="flex flex-col lg:flex-row gap-7 md:pt-[40px] px-5 sm:px-16 lg:px-0">
              <div className="w-full gap-2 flex flex-col  items-center">
                ...
                <div className="">
                  ...
                  <p className="font-normal font-Gilroy text-center text-[12px] md:text-[16px]  text-lite_black leading-[19.41px] pt-1 md:pt-5">
      ...
      <div className="container">
        <div className="flex flex-col lg:flex-row justify-between items-center gap-12 md:gap-0 md:py-[50px] px-4 lg:px-0">
          <div className="w-full max-w-[522px]">
            ...
            <div className=" pt-[24px] w-full max-w-[522px]">
              <p className="font-normal font-Gilroy text-[15px] lg:text-[18px] text-light_gray leading-[28px]">
      ...
      <div className="container">
        <div className="flex flex-col lg:flex-row justify-between items-center gap-12 md:gap-0 px-4 lg:px-0">
          ...
          <div className="w-full max-w-[522px]">
            ...
            <div className=" pt-[24px] w-full max-w-[522px]">
              <p className="font-normal font-Gilroy text-[15px] md:text-[18px] text-light_gray leading-[36px]">
