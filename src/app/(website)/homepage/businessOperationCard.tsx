    ...
    <div className="container py-8">
      <div className="flex flex-wrap max-w-[964px] w-full items-center justify-between mx-auto 
        ...
        {businessOperationTabs.map((tab) => (
          ...
          >
            <div
              className={`flex flex-col size-[100px] px-2 justify-center items-center space-y-3 rounded-[16px] ${schestiBusinessOperation == tab.title ? 'shadow-tabsShadow scale-95 businessOprationImage' : ''}  hover:shadow-tabsShadow transform transition-transform duration-300 hover:scale-95 logo`}
            >
              <Image
                src={tab.image}
                alt={tab.title}
      ...
      {schestiBusinessOperation === 'Bidding' ? (
        <div className="flex flex-col items-center justify-between px-4 mx-auto mt-10 lg:flex-row">
          <div className="max-w-full lg:max-w-[434px] lg:pr-4">
            ...
            <div className="font-bold font-Gilroy text-[24px] lg:text-[32px] leading-[36px] lg:leading-[48px] -tracking-[1.2px] text-gray mt-4 lg:mt-6">
              Unlock the Future of Bid Management with SCHESTI
            </div>
            <div className="font-regular font-Gilroy text-h2 -tracking-[0.2px] text-gray opacity-70 mt-4 lg:mt-6">
            ...
            <div className="mt-6 lg:mt-8">
              <button className="flex flex-row items-center gap-[10px] font-Gilroy font-bold text-blue group">
                Read more
                <img
        ...
        <div className=" mx-auto px-4 flex flex-col lg:flex-row items-center mt-[30px] justify-between">
          <div className="max-w-full lg:max-w-[434px] lg:pr-4">
            <div className="font-bold text-h4 font-Gilroy tracking-[1.6px] text-[#FFC107] uppercase  lg:text-xl">
              CRM
            </div>
            <div className="font-bold font-Gilroy text-[24px] lg:text-[32px] leading-[36px] lg:leading-[48px] -tracking-[1.2px] text-gray mt-4 lg:mt-6">
        ...
        <div className=" mx-auto px-4 flex flex-col lg:flex-row items-center mt-[30px] justify-between lg:gap-[73px]">
          ...
          <div className="max-w-full lg:max-w-[534px] lg:pr-4">
            ...
            <div className="font-bold font-Gilroy text-[24px] lg:text-[32px] leading-[36px] lg:leading-[48px] -tracking-[1.2px] text-gray mt-4 lg:mt-6">
              Enhance Collaboration with SCHESTI: Screen Sharing, Online Video
              Calls, Meetings, and Conferencing
            </div>
            <div className="font-regular font-Gilroy text-h2 -tracking-[0.2px] text-gray opacity-70 mt-4 lg:mt-6">
