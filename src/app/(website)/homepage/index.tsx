      ...
      <div className="max-w-full h-[504px] flex items-center justify-center bg-[#F7FAFC]">
        <div className="relative flex items-center justify-center w-full h-full">
          ...
          <div className="text-center max-w-[90%] md:max-w-[1000px] px-2 sm:px-4">
            ...
            <div
              className= "text-[24px] sm:text-[32px] md:text-[35px] xl:text-[40px] leading-[32px] sm:leading-[48px] md:leading-[56px] text-[#002B40] mt-4 sm:mt-6 font-extrabold font-jakarta"
            >
