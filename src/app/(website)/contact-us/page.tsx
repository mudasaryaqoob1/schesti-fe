              ...
              <div className="px-[45px] py-[44px]">
                <div className="flex justify-between lg:flex-row gap-7 flex-col">
                  <div className="w-full lg:max-w-[495px]">
                    <div className="">
                      <h1 className="font-Gilroy font-bold text-[13px] md:text-[15px] text-left text-[#161C2D] leading-[-0.1px] md:leading-[26px] pb-2">
                        First & Last Name
                      </h1>
                    </div>
                    <div className="w-full lg:max-w-[495px] border-[1px] border-[#E7E9ED] rounded-[10px] bg-white">
                      <input
                        className="font-Gilroy outline-none rounded-[10px] font-normal text-[13px] md:text-[15px] text-left text-[#161C2D] leading-[-0.1px] md:leading-[26px] px-[18px] py-3"
                        type="text"
                  ...
                  <div className="w-full lg:max-w-[1025px]">
                    ...
                    <div className="w-full lg:max-w-[1025px] border-[1px] border-[#E7E9ED] rounded-[10px] bg-white">
                      <textarea
                        ...
                        className="w-full font-Gilroy outline-none rounded-[10px] font-normal text-[13px] md:text-[15px] text-left text-[#161C2D] leading-[-0.1px] md:leading-[26px] px-[18px] py-3"
