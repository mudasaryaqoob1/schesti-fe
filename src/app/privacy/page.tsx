...
function Description({ description, title, children }: { title: string, description?: string, children?: React.ReactNode }) {
    return <div id={title} className="mb-2 space-y-2">
        <h3 className="text-[#333E4F] text-base leading-7 font-semibold">{title}</h3>
        {children ? children : <p className="text-[#333E4F] text-base leading-7 font-normal">
            {description}
        </p>}
    </div>
}