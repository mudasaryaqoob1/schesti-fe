...
export const planFeatureOptions = [
    {
        title: "Bid Management", label: 'Bid Management', options: [
    ...
    {
        title: "Quantity Takeoff", label: 'Quantity Takeoff', options: [
    ...
    {
        title: "Estimates", label: 'Estimates', options: [
            { label: "Estimates Requests", value: Routes.Estimates["Estimates-Requests"] },
            { label: "Estimates List", value: Routes.Estimates["Estimates-List"] },
        ]
    },

    {
        title: "Financial", label: 'Financial', options: [
            { label: "Standard Invoicing", value: Routes.Financial["Standard-Invoicing"] },
    ...
    {
        label: "Schedule", value: Routes.Schedule
    },

    {
        label: "Meetings", value: Routes.Meetings
    },

    {
        label: "Networking", value: Routes.Networking
    },

]


export function getPlanFeatureKeyByValue(value: string, options = planFeatureOptions) {
