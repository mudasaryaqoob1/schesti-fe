...
const Index: React.FC<SwitchBtnProps> = ({ onChange }) => {
    ...
    return (
        <label htmlFor="Toggle1" className="inline-flex gap-6 items-center space-x-4 cursor-pointer dark:text-gray-100">
            <span className={`${tertiaryHeading} font-normal`}>Monthly</span>
            <span className="relative">
                <input id="Toggle1" type="checkbox" className="hidden peer" checked={isYearly} onChange={handleSwitch} />
