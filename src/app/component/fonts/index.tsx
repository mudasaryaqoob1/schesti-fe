import { Great_Vibes, Dancing_Script, Sacramento, Cookie, Satisfy, Pacifico, } from 'next/font/google'
...
export type ChooseFontType = 'greatVibesFont' | 'dancingScriptFont' | 'sacramentoFont' | 'cookieFont' | 'satisfyFont' | 'pacificoFont';
...
export function ChooseFont({ text, chooseFont = "satisfyFont", }: Props) {
    ...
    return <div style={SignatureFonts[chooseFont].style}>
        {text}
    </div>
}