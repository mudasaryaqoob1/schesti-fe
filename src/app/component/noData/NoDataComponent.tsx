...
export function NoDataComponent({ description = "You don't have any data yet.", imageSrc = '/estimateempty.svg', title = "No Existing Data" }: Props) {

    return <div className="max-w-[500px] flex flex-col items-center p-4">
