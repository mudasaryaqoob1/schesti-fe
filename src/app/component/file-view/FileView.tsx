...
export function FileView({ extension, name, url, text = "Download", actionIcon }: Props) {
    return <div className='mt-2 p-2 flex bg-white items-center border border-[#E1E5EA] rounded-md w-[270px] space-x-2'>
