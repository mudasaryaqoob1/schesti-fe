...
import {
  EnterpriseplansMonthly,
  Enterpriseplansyearly,
  IndividualplansMonthly,
  Individualplansyearly,
} from './data';
interface PlanInfo {
  title: string;
  price: number | string;
...
const PaymentPlans = () => {
  ...
  const selectedPlans = isEnterprise
    ? isYearly
      ? Enterpriseplansyearly
      : EnterpriseplansMonthly
    : isYearly
  ...
  return (
    <>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 sm:grid-cols-2 gap-5">
        {selectedPlans?.map(
          (plan: PlanInfo, index: React.Key | null | undefined) => {
