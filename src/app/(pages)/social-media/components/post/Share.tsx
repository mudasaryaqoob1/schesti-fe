...
const SharePost = ({ url }: { url: string }) => {
    ...
    return (
        <>
            <ModalComponent destroyOnClose width="500px" open={showModal} setOpen={setShowModal}>
                <div className="bg-white px-6 py-4 rounded-lg">
                    ...
                    <div className="flex flex-col gap-4 mt-4">
                        <FacebookShareButton url={url} className='flex gap-2 items-center'>
                            ...
                            <p className='text-graphiteGray font-semibold text-md'>Facebook</p>
                        </FacebookShareButton>
                        ...
                        <LinkedinShareButton url={url} className='flex gap-2 items-center'>
                            ...
                            <p className='text-graphiteGray font-semibold text-md'>Linkedin</p>
                        </LinkedinShareButton>
                        <div className="flex gap-2 items-center cursor-pointer" onClick={() => {
                            ...
                            <Image
                                ...
                                onClick={() => setShowModal(false)}
                            />
                            <p className='text-graphiteGray font-semibold text-md'>Copy link</p>
                        </div>
                    </div>
                </div>
            </ModalComponent>
