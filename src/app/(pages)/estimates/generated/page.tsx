...
import { Add, Custom, Multiple, New, Summary, TakeOff } from './components'
...
const Generated = () => {
    ...
    const Estimates = [TakeOff, Add, New, Custom, Multiple, Summary];
    const EstimateComponent = Estimates[prevNext];
    return (
        <Wrapper className="md:px-16 px-5 pb-8">
            <article className="p-5 md:flex hidden justify-center w-full  shadow-secondaryTwist rounded-xl 
