...
const Multiple = ({ setPrevNext }: Props) => {
    const submitHandler = () => { };
    return (
        <div>
            {/* scope */}
            ...
            <div className="block justify-between items-center md:flex">
                <TertiaryHeading
                    title="Scope"
                    className="md:text-start text-center text-graphiteGray font-semibold"
                />
                <div className="grid grid-cols-1 grid-rows-1 md:grid-cols-3 gap-x-2 md:gap-y-0 gap-y-3">
    ...
    border-2 border-solid !border-celestialGray"
                    ...
                    <CustomButton text="Next" className="!w-full" onClick={() => setPrevNext(prev => prev + 1)} />
                </div>
            </div>
            <Formik
