...
import { Backgrounder, senaryHeading, tertiaryHeading } from '@/globals/tailwindvariables';
...
const page = () => {
    ...
    return (
        ...
        ">
                ...
                {/*  */}
                <div className="flex justify-between items-center mb-3 md:my-1 my-2">
                    <TertiaryHeading
                        title="Scope"
                        className="text-graphiteGray font-semibold"
                    />
              ...
              border-2 border-solid !border-celestialGray"
                        ...
                        <CustomButton text="Next" className="!w-full"
                            onClick={() => router.push('/estimates/generated/summary')}
                        />
                    </div>
                </div>
                <Formik
                            ...
                            >
                                ...
                                <div className="md:flex block  items-center gap-1 md:flex-row flex-wrap">
                                    ...
                                    <FormControl
                                        ...
                                        className="2xl:w-[700] md:w-[200px] py-3 w-full"
                                    />
                                    <FormControl
                                        control="input"
                                        type="text"
