        ...
        <div className="p-5 flex flex-col rounded-lg border border-silverGray shadow-secondaryShadow2 bg-white">
            ...
            <div className="grid grid-cols-5 gap-5 mt-5">
                <div>
                    ...
                    <QuaternaryHeading
                        title={invoiceData.invoiceSubject}
                    />
                </div>
                <div>
                    <QuinaryHeading
                ...
                <div>
                    ...
                    <QuaternaryHeading
                        title={invoiceData.applicationNumber}
                    />
                </div>
                <div>
                    <QuinaryHeading
                ...
                <div>
                    ...
                    <QuaternaryHeading
                        title={invoiceData.subContractorFirstName + " " + invoiceData.subContractorLastName}
                    />
                </div>
                <div>
                    <QuinaryHeading
                ...
                <div>
                    ...
                    <QuaternaryHeading
                        title={invoiceData.subContractorEmail}
                    />
                </div>
                <div>
                    <QuinaryHeading
                    ...
                    <QuaternaryHeading
                        title={invoiceData.subContractorCompanyName}
                    />
                </div>
                <div>
                    <QuinaryHeading
                    ...
                    <QuaternaryHeading
                        title={invoiceData.subContractorAddress}
                    />
                </div>
            </div>
        </div>
