...
export const SCALE_NAVIGATION: ScaleNavigation[] = [
  {
    label: 'scale',
    src: '/nav/scale.svg',
    selectedSrc: '/nav/selectedScale.svg',
    alt: 'createicon',
    width: 19.97,
    height: 11.31,
  },
  {
    label: 'length',
    src: '/nav/length.svg',
    selectedSrc: '/nav/selectedLength.svg',
    alt: 'createicon',
    width: 19.97,
    height: 11.31,
  },
  {
    label: 'rectangle',
    src: '/nav/rectangle.svg',
    selectedSrc: '/nav/selectedRectangle.svg',
    alt: 'createicon',
    width: 19.97,
    height: 11.31,
  },
  ...
  },
  {
    label: 'dynamic',
    src: '/nav/dynamic.svg',
    selectedSrc: '/nav/selectedDynamic.svg',
    alt: 'createicon',
    width: 15,
    height: 14,
  },
  {
    label: 'perimeter',
    src: '/nav/perimeter.svg',
    selectedSrc: '/nav/selectedPerimeter.svg',
    alt: 'createicon',
    width: 15,
    height: 14,
  },
