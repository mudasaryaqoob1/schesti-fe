...
const EditSupportTicket = () => {
    ...
    const [supportTicketData, setSupportTicketData] = useState<ISupportTicket | null>(null);

    useEffect(() => {
        setSupportTicketData(supportTicketsData?.find((item: any) => item._id === id));
            ...
            <section className='px-16 mt-6'>
                ...
                <div className='mt-6 grid grid-cols-3 mb-3'>
                    ...
                    <div className='col-span-2'>
                        <Formik
                            initialValues={supportTicketData ? { title: supportTicketData.title, description: supportTicketData.description } : initialValues}
            ...
            border-silverGray pb-4 rounded-lg "
                        ...
                        text-RoyalPurple font-semibold`
                                        ...
                                        <div className="flex justify-end gap-2 mt-6">
                                            ...
                                            <span>
                                                <CustomButton text='Update Ticket'
                                                    type='submit'
