                ...
                <SelectComponent
                    ...
                    field={{
                        options: [
                            ...
                            { label: "New Construction with Site Work", value: "New Construction with Site Work" },
                            { label: "New Construction no Site Work", value: "New Construction no Site Work" },
                            { label: "Renovation/Remodel/Repair", value: "Renovation/Remodel/Repair" },
                ...
                <SelectComponent
                    ...
                    field={{
                        options: [
                            ...
                            { label: 'Assisted Living Facility/Elder Care', value: 'Assisted Living Facility/Elder Care' },
                            { label: 'Auto Dealership', value: 'Auto Dealership' },
                            { label: 'Bank/Financial', value: 'Bank/Financial' },
                            { label: 'Casino', value: 'Casino' },
                            { label: 'Clinic/Hospital/Medical', value: 'Clinic/Hospital/Medical' },
                            { label: 'Clubhouse', value: 'Clubhouse' },
                            { label: 'Conference/Convention Center', value: 'Conference/Convention Center' },
                            { label: 'Convenience Store/Gas Station', value: 'Convenience Store/Gas Station' },
                            ...
                            { label: 'Service Station/Car Wash', value: 'Service Station/Car Wash' },
                            ...
                            { label: 'Sidewalk/Parking Lot', value: 'Sidewalk/Parking Lot' },
                            { label: 'Solid Waste Station', value: 'Solid Waste Station' },
                            { label: 'Train Station', value: 'Train Station' },
                            { label: 'Transportation Terminal', value: 'Transportation Terminal' },
                            { label: 'Waste Water Treatment', value: 'Waste Water Treatment' },
            ...
            <SelectComponent
                ...
                field={{
                    options: [
                        ...
                        { label: "GC Awarded/Sub Bidding", value: "GC Awarded/Sub Bidding" },
                        { label: "Closed/Subcontractor Awarded", value: "Closed/Subcontractor Awarded" },
