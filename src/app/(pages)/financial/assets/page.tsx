...
function AssetPage() {
    ...
    const [selectedItem, setSelectedItem] = useState<IFinancialAsset | null>(null);
    ...
    const columns: ColumnsType<IFinancialAsset> = [
        {
            title: 'Sr#', render(value, record, index) {
                return index + 1
            },
        },
        ...
        {
            title: 'Date', dataIndex: "assetDate", render(value) {
    ...
    async function fetchData() {
        setIsloading(true);
        try {
            const response = await financialAssetService.httpGetAllAssets(pagination.page, pagination.limit);
            if (response.data) {
    ...
    return (
        <section className="mt-6  space-y-2 mb-[39px] mx-4 rounded-xl bg-white p-5">
            ...
            <div className="flex justify-between items-center mb-4">
                <TertiaryHeading title="Assets/Inventory" className="text-graphiteGray" />
