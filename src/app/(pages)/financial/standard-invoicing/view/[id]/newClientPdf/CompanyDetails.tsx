...
export function PdfCompanyDetails({ invoice, user }: Props) {
  return (
    <View style={[{ marginTop: 128, paddingHorizontal: 48 }]}>
      <View
        style={[
          {
      ...
      >
        {user.avatar ? (
          <Image src={user.avatar} style={[{ width: 320, height: 190 }]} />
        ) : (
          <Text>Schesti</Text>
        )}
        <View style={[{ paddingRight: 16, paddingTop: 48 }]}>
          <Text style={{ color: LightBalck, fontSize: 12, lineHeight: 20 }}>
            {user.name}
          </Text>
          <Text style={{ color: LightBalck, fontSize: 12, lineHeight: 20 }}>
            {user.email}
      ...
      >
        ...
        >
          <Text style={[{ color: PurpleColor, fontSize: 12, lineHeight: 20 }]}>
        ...
        >
          <View>
            ...
            <Text style={[{ color: DarkColor, fontSize: 30, lineHeight: 44 }]}>
