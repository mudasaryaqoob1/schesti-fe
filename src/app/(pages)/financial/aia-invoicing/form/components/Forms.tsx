...
const ValidationSchema = Yup.object().shape({
    lienWaiverFiles: Yup.array().of(
        Yup.mixed()
    ),
    salesFiles: Yup.array().of(
        Yup.mixed()
    ),
    federalPaperFiles: Yup.array().of(
        Yup.mixed()
    ),
    materialsFiles: Yup.array().of(
        Yup.mixed()
    ),
    ...
    return <div className="pb-4">
        ...
        <div className="grid grid-cols-2 gap-4">
            <div className="border rounded-md p-2">
                ...
                {!formik.values.lienWaiverFiles.length ? <Spin spinning={isUploadig.lienWaiver} indicator={<LoadingOutlined spin />}>
                    <Dragger
                        name={'file'}
                        ...
                        beforeUpload={async (file, fileList) => {
                            const [isValidSize, allowedSize] = fileSizeValidator(fileList);

                            if (!isValidSize) {
                                toast.error(`File size should be less than ${allowedSize}MB`);
                                return false;
                            }
                            setIsUploading(prev => ({ ...prev, lienWaiver: true }));
                            try {
                                const files = await uploadFilesToS3(fileList, "/aia-invoice");
            ...
            <div className="border rounded-md p-2">
                ...
                {!formik.values.salesFiles.length ? <Spin spinning={isUploadig.sales} indicator={<LoadingOutlined spin />}> <Dragger
                    name={'file'}
                    accept="image/*,gif,application/pdf"
                    multiple={true}
                    style={{
            ...
            <div className="border rounded-md p-2">
                <PrimaryHeading
                    title="Federal Papers"
                    className="!text-[18px]"
                />

                {!formik.values.federalPaperFiles.length ? <Spin spinning={isUploadig.federalPaper} indicator={<LoadingOutlined spin />}>  <Dragger
                    name={'file'}
                    accept="image/*,gif,application/pdf"
                    multiple={true}
                    style={{
                    ...
                    beforeUpload={async (file, fileList) => {
                        ...
                        try {
                            ...
                            setIsUploading(prev => ({ ...prev, federalPaper: false }));
                        }
                ...
                </Spin> : <div className="flex space-x-2 items-center">
            ...
            <div className="border rounded-md p-2">
                ...
                {!formik.values.materialsFiles.length ? <Spin spinning={isUploadig.materials} indicator={<LoadingOutlined spin />}> <Dragger
                    name={'file'}
                    accept="image/*,gif,application/pdf"
                    multiple={true}
                    style={{
            ...
            <div className="col-span-2 border rounded-md p-2">
                ...
                {!formik.values.otherFiles.length ? <Spin spinning={isUploadig.others} indicator={<LoadingOutlined spin />}> <Dragger
                    name={'file'}
                    accept="image/*,gif,application/pdf"
                    multiple={true}
                    style={{
