...
const MySubscription = (props: Partial<Props>) => {
    const { planName = 'My Subscriptions', monthlyPrice = '25', planDescription = 'New Testing Description', features = 'CRM,Takeoff Module,Construction Estimate Module', isYearly = false, yearlyPrice = '100' } = props;
    ...
    return (
        <>
            ...
            text-[42px] leading-[46px] !text-goldenrodYellow"
                        ...
                        <p className='text-end text-vividRed font-semibold w-full'>Expires in 14 days left</p>
