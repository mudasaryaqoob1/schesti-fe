...
const Index: React.FC<SwitchBtnProps> = ({ isDuration, onChange }) => {
  return (
    ...
    >
      <span className={`${tertiaryHeading} font-normal ${isDuration == 'monthly' ? "text-black font-bold" : "font-normal text-gray-400"}`}>Monthly</span>
      ...
      <span className={`${tertiaryHeading} font-normal ${isDuration == 'yearly' ? "text-black font-bold" : "font-normal text-gray-400"}`}>Yearly</span>
    </label>
  );
};
