...
const BidManagementProjectTeam = () => {
                ...
                <div className="relative overflow-x-auto border border-graylighty mt-5">
                  <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                    ...
                    <tbody className="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                      {tableData.slice(startTableIndex, endTableIndex).map(
                        (item, index) =>
                          item.name && (
                            <tr
                              key={index}
                              className="bg-white dark:bg-gray-800 dark:border-gray-700 border"
                            >
                              <th
                                scope="row"
...
export default BidManagementProjectTeam;
